 ...
 * <p>
 * Modal events are capable of passing on data about the event while the event
 * is on the modal phase.
 * 
 * @author michael
 */
public class SingleHandlerGoModalEvent extends SingleHandlerGoEvent {
	/**
	 * This method notifies the handler, if it supports the
	 * {@link GOModalEventHandler}, that the event data has changed.
	 */
