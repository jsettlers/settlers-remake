...
public class TextureCompiler implements Runnable, TextureIndex {
	...
	private Hashtable<String, Integer> imageIndexes =
	...
	private void openTextureIndex() throws IOException {
		...
		textureIndexOut.write(new byte[] {
		        'T', 'E', 'X', '1'
		});
	...
	private void closeTextureIndex() throws IOException {
		ArrayList<String> sortedIndexes =
		        new ArrayList<String>(imageIndexes.keySet());
	...
	public void registerTexture(String name, int textureFile, int offsetx,
	        int offsety, int width, int height, boolean hasTorso, TexturePosition position)
	        throws IOException {
