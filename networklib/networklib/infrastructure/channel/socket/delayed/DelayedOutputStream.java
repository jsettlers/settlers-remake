...
public class DelayedOutputStream extends OutputStream {
	...
	protected static final int MAX_DELAY_STEP = 10;

	protected static final int MIN_DELAY = 50;
	protected static final int MAX_DELAY = 250;
	...
	public DelayedOutputStream(OutputStream out) {
		...
		thread = new Thread("delayedOutStreamWriter") {
			@Override
			public void run() {
				while (!closed) {
