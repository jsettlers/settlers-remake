...
public class JoinMatchListener extends PacketChannelListener<IdPacket> {
	...
	public JoinMatchListener(IServerManager serverManager, Player player) {
		super(NetworkConstants.Keys.REQUEST_JOIN_MATCH, new GenericDeserializer<IdPacket>(IdPacket.class));
		this.serverManager = serverManager;
		this.player = player;
	}

	@Override
	protected void receivePacket(int key, IdPacket packet) throws IOException {
