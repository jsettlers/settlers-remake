...
public class MiniMapLayoutProperties {
    ...
    public final OriginalImageLink IMAGELINK_BUTTON_FEATURES_PLAIN;
    public final OriginalImageLink IMAGELINK_BUTTON_FEATURES_SHOW;
    public final OriginalImageLink IMAGELINK_BUTTON_FEATURES_BORDERFILL;
    public final OriginalImageLink IMAGELINK_BUTTON_SETTLERS_HIDE;
    public final OriginalImageLink IMAGELINK_BUTTON_SETTLERS_SHOW;
    public final OriginalImageLink IMAGELINK_BUTTON_SETTLERS_SOLDIERSONLY;
    public final OriginalImageLink IMAGELINK_BUTTON_BUILDINGS_HIDE;
    public final OriginalImageLink IMAGELINK_BUTTON_BUILDINGS_SHOW;
    ...
    public MiniMapLayoutProperties(Resolution resolution) {
        ...
        IMAGELINK_BUTTON_FEATURES_PLAIN = new OriginalImageLink(BUTTONS_SUBFOLDER, BUTTONS_FOLDER_INDEX, 342, imageSequenceNumber);
        IMAGELINK_BUTTON_FEATURES_SHOW = new OriginalImageLink(BUTTONS_SUBFOLDER, BUTTONS_FOLDER_INDEX, 348, imageSequenceNumber);
        IMAGELINK_BUTTON_FEATURES_BORDERFILL = new OriginalImageLink(BUTTONS_SUBFOLDER, BUTTONS_FOLDER_INDEX, 345, imageSequenceNumber);
        IMAGELINK_BUTTON_SETTLERS_HIDE = new OriginalImageLink(BUTTONS_SUBFOLDER, BUTTONS_FOLDER_INDEX, 351, imageSequenceNumber);
        IMAGELINK_BUTTON_SETTLERS_SHOW = new OriginalImageLink(BUTTONS_SUBFOLDER, BUTTONS_FOLDER_INDEX, 354, imageSequenceNumber);
        IMAGELINK_BUTTON_SETTLERS_SOLDIERSONLY = new OriginalImageLink(BUTTONS_SUBFOLDER, BUTTONS_FOLDER_INDEX, 357, imageSequenceNumber);
        IMAGELINK_BUTTON_BUILDINGS_HIDE = new OriginalImageLink(BUTTONS_SUBFOLDER, BUTTONS_FOLDER_INDEX, 363, imageSequenceNumber);
        IMAGELINK_BUTTON_BUILDINGS_SHOW = new OriginalImageLink(BUTTONS_SUBFOLDER, BUTTONS_FOLDER_INDEX, 360, imageSequenceNumber);
    }
}