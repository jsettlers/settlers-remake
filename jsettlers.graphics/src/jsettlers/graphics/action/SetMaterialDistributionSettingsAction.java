...
/**
 * This {@link Action} is used to set the distribution settings for a material
 * in a manager.
 * 
...
public class SetMaterialDistributionSettingsAction extends Action {
	...
	/**
	 * @return Returns a position occupied by the manager this settings shall be
	 *         used for.
	 */
	...
	/**
	 * @return Returns the {@link EMaterialType} this settings shall be used
	 *         for.
	 */
	...
	/**
	 * @return Returns the new distribution probabilities. The values correspond
