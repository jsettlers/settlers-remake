...
public class SelfDeletingMapObject extends AbstractHexMapObject implements ITimerable, IPlayerable {
	 ...
	 */
	public SelfDeletingMapObject(IMapObjectRemovableGrid grid, EMapObjectType type, float duration) {
		this(grid, type, duration, (byte) -1);
	}

	public SelfDeletingMapObject(IMapObjectRemovableGrid grid, EMapObjectType type, float duration, byte player) {
		this.grid = grid;
		this.player = player;
		this.type = type;
