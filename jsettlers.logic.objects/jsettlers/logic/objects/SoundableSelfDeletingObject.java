...
public class SoundableSelfDeletingObject extends SelfDeletingMapObject implements ISoundable {
	...
	public SoundableSelfDeletingObject(ISPosition2D pos, EMapObjectType type, float duration) {
		super(pos, type, duration);
	}

	public SoundableSelfDeletingObject(ISPosition2D pos, EMapObjectType type, float duration, byte player) {
